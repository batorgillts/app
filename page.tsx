  ...
  return (
    <StyledHome data-testid="container">
      <div className="home-container">
        {bunnyState === "yes" ? <div className="title">Let's GOOOO Baby  !!!!</div> : <div className="title">WILL YOU BE MY VALENTINE?</div>}
        <div className="animation">
          {bunnyState === "normal" && <Lottie options={bunnyPleaseOptions} height={300} width={300} />}
          {bunnyState === "cry" && <Lottie options={bunnyCryOptions} height={500} width={500} /> && <div className="title">Pretty Please :3</div>}
          {bunnyState === "yes" && <Lottie options={bunnyYesOptions} height={700} width={700} />}
          {bunnyState === "punch" && <Lottie options={bunnyPunchOptions} height={500} width={500} />}
        </div>
